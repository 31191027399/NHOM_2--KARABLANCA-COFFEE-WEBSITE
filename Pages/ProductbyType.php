        ...
        <div class="grid">
            <div class="grid__row search__content">
                ...
                <div class="grid__column-10">
                    ...
                    <div class="search-result">
                        <div class="grid_row">
                            ...
                            if (isset($_GET['title'])) {
                                ...
                                $sql_search = "SELECT * FROM sanpham WHERE maloaisp='$searchby' LIMIT $from,$sosp1trang";
                    ...
                    <?php
                    $sql_trang = "SELECT * FROM sanpham WHERE maloaisp='$searchby'";
                    ...
                    <ul class="pagination search-product__pagination">
                        ...
                        <?php for ($t = 1; $t <= $sotrang; $t++) { ?>
                            <li class="pagination-item pagination-item--active">
                                <a href="ProductbyType.php?title=<?php echo "$searchby" ?>page<?php echo "$t" ?>" 
